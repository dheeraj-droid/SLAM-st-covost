...
def generate_audio_from_text(text: str, output_path: str, lang: str = "de") -> None:
    """
    ...
    Args:
        ...
        lang (str): Language for text-to-speech conversion (default: "en").
    """
...
def Inference(kwargs: DictConfig):
    ...
    model = CustomSLM(config,ckpt_path="/home/CP/speech/data/qwen/cotst-all/asr_epoch_1_step_2000/model.pt")
    ...
    for step, batch in tqdm(enumerate(test_dataloader), total=len(test_dataloader)):
        ...
        for key, text, target in zip(batch["keys"], output_text, batch["targets"]):
            ...
            if delimiter in text:
                result = text.split(delimiter, 1)[1].strip()
            else:
                result = ""
            ...
            print(result)
            output_audio_path = f"/home/CP/SLAM-LLM/examples/st_covost2/outs/{i}_{source}.mp3"
            i=i+1
            generate_audio_from_text(text, output_audio_path)
