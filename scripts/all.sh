...
train_data_path=${code_dir}/speech/data/qwen/train_spt_0926.jsonl
val_data_path=${code_dir}/speech/data/qwen/dev_spt_0926.jsonl
...
ckpt_name=${code_dir}/speech/data/qwen/asr-pretrain/asr_epoch_5_step_740/model.pt
