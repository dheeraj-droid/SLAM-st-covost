...
ckpt_path=${code_dir}/speech/data/qwen/cotst-all/asr_epoch_1_step_2000/model.pt
if [ ! -f "$ckpt_path" ]; then
    echo "Download ckpt..."
...
val_data_path=/home/CP/speech/data/qwen2/test_spt_0926.jsonl
local_dataset_path=${code_dir}/speech/data/qwen2/

torchrun \
    --nnodes 1 \
    --nproc_per_node ${gpu_count} \
    --master_port=29503 \
    ${code_dir}/SLAM-LLM/examples/st_covost2/inference_asr_batch2.py \
    --config-path "conf" \
    ...
    ++dataset_config.local_dataset_path=$local_dataset_path \
